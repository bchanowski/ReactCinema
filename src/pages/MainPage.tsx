...
const MainPage = () => {
  return (
    <div className="flex justify-center items-center w-full flex-col">
      <div className="flex flex-col sm:justify-center items-center lg:flex-row h-[500px] sm:h-[800px] lg:h-[600px] w-full sm:w-[635px] md:w-[1024px] xl:w-[1200px] 2xl:w-[1400px]">
